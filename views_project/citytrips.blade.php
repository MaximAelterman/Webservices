	...
	<div id="content">
		<table class="table table-hover">
			...
			@foreach($citytrips as $trip)
				...
				<tr>
				<td class="tbl_foto"><a href="vakantie/citytrips/{{ $trip->id }}"><img class="img-responsive" src="{{ URL::asset('assets/img/vakanties/vakantie'.$trip->id.'/'.'vak0.jpg') }}" alt="foto"/></a></td>
				<td>
					<div class="tbl_info">
						<p>{{ $trip->naam }} </p>
						<p>
				...
				<td>
					<div>
						<a href="vakantie/ski/{{ $trip->id }}"><button type="button" class="btn btn-primary btn-lg infoknop">Meer info <span class="glyphicon glyphicon-chevron-right" style="color:white"></span></button></a>
